    ...
    <div class="card-header border-0">
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-3 col-lg-2 col-xl-1">
                <a href="{{ route('dashboard.pages.create') }}" class="btn btn-danger btn-sm">Adicionar</a>
            </div>
        </div>
    </div>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{ route('dashboard.pages.edit', $item) }}">
                                        <i class="fas fa-edit"></i>Editar
                                    </a>
                                    @livewire('delete', ['route' => route('dashboard.pages.destroy',
                                    $item)],key($item->id))
                                </div>
                            </div>
                        </td>
