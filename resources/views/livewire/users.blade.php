    ...
    <div class="card-header border-0">
        ...
        <div class="row">
            ...
            <div class="col-4 col-md-3 col-lg-2 col-xl-1">
                <a href="{{ route('dashboard.users.create') }}" class="btn btn-danger btn-sm">Adicionar</a>
            </div>
        </div>
    </div>
        ...
        <table class="table align-items-center table-flush">
            <thead class="thead-light">
                <tr>
                    ...
                    <th scope="col" class="sort" data-sort="usuario">E-mail</th>
            ...
            <tbody class="list">
                @foreach ($items as $item)
                    <tr>
                        <th>
                            <img src="{{ Storage::url($item->hasfiles->file->filename) }}" width="200">
                        </th>
                        <td class="budget">
                            {{ $item->name }}
                        </td>
                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="{{ route('dashboard.users.edit', $item) }}">
                                        <i class="fas fa-edit"></i>Editar
                                    </a>
                                    @livewire('delete', ['route' => route('dashboard.users.destroy',$item)],key($item->id))
                                </div>
                            </div>
                        </td>
                    </tr>
